...
pub use persistence::{
    ...
    FailurePolicyError, ForkError, ForkWork, LifecycleError, LogicalCommit, LogicalJournalRecord,
    LogicalJournalStore, LogicalWorkTransition, ManualPlatformClock, PersistenceFuture,
    PlatformClock, PlatformTime, ReadError, RuntimeCapabilityImplementation, RuntimeControlStore,
