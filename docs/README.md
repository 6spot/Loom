...
- Quickstart (start stack, Catalog/`WorldTemplateDescriptor`/World/Action/State/History/Relationship/blob/semantic, Ingress/feed, Scheduler/World Time after target config, replay/fork, provenance, deterministic Agency via neutral fixture): [`quickstart.md`](quickstart.md)
