...
- CI / verification: GitHub Actions run `32456637507` — PostgreSQL 18 persistence contract success; Rust Ubuntu success; Rust macOS success; Architecture, Format, Check, Clippy, Test and Rustdoc all green.
