...
- 2026-08-27 — D-013 follow-up: parent-qualified `direct_effects(E1)` now explicitly excludes both child E2 and sibling EventRef/state, and CV-026 Pass includes the sibling direct-effects exclusion predicate; no cross-Timeline reverse discovery is required.
