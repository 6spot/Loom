...
terminal rerun recorded; T22's current refresh is open in PR #366 (base
`95f7e7a0233cfa917d0c9656b990fd2af4996874`, head
`98258a4fe89f118745c534e09b51edcfac4bcde9`, PG18 check passed and Rust check
pending); T23 and T24 have no complete current-main rerun recorded. Their
merged PRs #363 and #362, their `34fc8efa77cf61d8a9261eaec575bbe111615618`
candidate evidence, and the old `31 Pass / 9 Unavailable` with
`gate_passes: false` remain historical/non-current evidence.
