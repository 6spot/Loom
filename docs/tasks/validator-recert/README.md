...
| T22 | ME-298 `done`; PR #366 merged at `7cd6844ff3459b5dad200a2807c452ad70195efc`, base `95f7e7a0233cfa917d0c9656b990fd2af4996874`, head `5dbe09bbdbc5f1c309dd59d96e1579c5b4125f34`; CI run `33159634407` passed both required jobs | Current-main manifest refresh is merged and consumed as an evidence-only descendant; it does not certify final V0 | PR #361 merge `34fc8efa77cf61d8a9261eaec575bbe111615618`; old `31 Pass / 9 Unavailable` and `gate_passes: false` |
...
| 3B | VALR-T22 — certification manifest | [#327](https://github.com/6spot/Loom/issues/327) | `done` | T22-owned `stage-3/t22-certification-manifest.md`; PR #366 merged at `7cd6844ff3459b5dad200a2807c452ad70195efc`; depends on #325 / T20 |
