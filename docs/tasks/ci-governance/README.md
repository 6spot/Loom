...
| CI-GOV-T04 | #543 | in_progress | CI-GOV-T03 | Retire completed Chronicle acceptance CI and disable stale Actions registrations while preserving historical evidence. |
