...
- [ ] Every corresponding GitHub child Issue/checklist/status agrees with its task file; GitHub acceptance checklists remain unchecked on the closed child Issues and require Leader-owned reconciliation.
...
- `gh issue list --state all` for #146–#203 found every blocking child #146–#202 closed, but the acceptance checklists in the closed child Issues remain unchecked. The release chain is PR #283 → `19c797d3e1e8bd20a21cda419789793623c5ca1f`, with #202 final candidate `52905862f3c26a6fb4d9991da2aa9fe8cfd11bc2` recorded in `t1-v0-release-gate.md`.
