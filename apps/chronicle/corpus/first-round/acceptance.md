...
## 27. 十三案独立复核工作包（原始–译文–引用/事件–边界；判定留空）

本工作包给出每案的原文锚点、当前 candidate 对应译文窗口，以及第 4 列的
**可核对观察（observation）或明标假设（[hypothesis]）**；不得把假设当结论。
**判定、依据、证据三栏一律留空**，由独立 reviewer 填写，本任务不预置、不代填。
译文窗口取自 SG `01a08b08`（revision `d848e43a`）/ZZ `01a08ad9`。

| 案 | 原文锚点 @[start,end) | 当前译文窗口（节选） | observation（可核对）/[hypothesis]（待判） | Reviewer 判定 / 依据 / 证据 |
| --- | --- | --- | --- | --- |
| C01 先主/備 | 先主姓劉，諱備 @[0,7)；先主少孤，與母販履織蓆為業 @[102,115) | sg0:「先主姓刘，名备，字玄德，是涿郡涿县人……」 | observation：原文开篇立「先主姓劉，諱備」；SG 先主傳 mentions 含 先主→ent_001。[hypothesis] 先主/備 同章共指成立 | |
| C02 周瑜/公瑾 | 周瑜字公瑾 @[0,5)；孤念公瑾，豈有已乎？ @[5006,5016) | sg1:「周瑜，字公瑾，是庐江舒县人……」 | observation：原文「周瑜字公瑾」；译文出现「公瑾」；bundle alias 含「公瑾」。[hypothesis] 同指周瑜 | |
| C03 魯肅/子敬 | 魯肅字子敬 @[0,5)；子敬，孤持鞍下馬相迎，足以顯卿未？ @[2068,2085) | sg2:「……子敬，我扶着马鞍下马迎接，足以显扬您了吗？」 | observation：原文「魯肅字子敬」；译文出现「子敬」「马鞍下马」。[hypothesis] 同指魯肅 | |
| C04 赤壁跨章 | 與曹公戰於赤壁，大破之 @[5114,5125)；遇於赤壁 @[2320,2324) | sg0:「和曹公在赤壁交战，大败曹军，焚烧他的船只……」；sg1:「军队继续前进，在赤壁与曹操相遇……」 | observation：当前各轮 resolve 未产生 先主傳↔周瑜傳 同 revision event candidate；`fdeec79e` 为 赤壁 place `same_entity`（跨束）。**不得以 `848a296f` 或历史 SG3 代替**（§25.5） | |
| C05 赤壁跨書 | 遇於赤壁 @[2320,2324)；進，與操遇於赤壁 @[9270,9278) | sg1:「……在赤壁相遇……」；zz:「军队继续前进，在赤壁与曹操相遇。」 | observation：原文两处均出现「赤壁」；§22 判据 cross_book×event 4/4 terminal（候选清单见服务器 review 列表）。[hypothesis] 两处属同一事件 | |
| C06 周瑜督軍跨書 | 遂以周瑜、程普為左右督，將兵與備並力逆操 @[9067,9087)；權遂遣瑜及程普等與備並力逆曹公 @[2304,2319) | zz:「于是任命周瑜、程普为左右都督，率军与刘备合力迎击曹操……」；sg1:「……与刘备合力迎击曹操……」 | observation：zz 译文「左右都督/合力」、sg1 译文「合力」（原文作「左右督/並力」）；§22 cross_book×entity 48/48 terminal。[hypothesis] 周瑜/程普 跨書同人 | |
| C07 南郡/江陵 | 追操至南郡 @[9577,9582)；留征南將軍曹仁、橫野將軍徐晃守江陵 @[9598,9615) | zz:「……等他到达南郡时，刘琮已经投降……」 | observation：原文同段相邻出现「南郡」与「江陵」；译文分别作「南郡」「江陵」。[hypothesis] 是否保持 uncertain/不合并由 reviewer 判定 | |
| C08 典略注 | 〈《典略》曰：備本臨邑侯枝屬也。〉 @[58,75) | sg0:「〈《典略》说：刘备原是临邑侯的支属。〉」 | observation：译文含「《典略》说：刘备原是临邑侯的支属」并带 〈〉 注符；原文锚点见左。[hypothesis] 嵌注归属 | |
| C09 江表傳注 | 《江表傳》曰：策又給瑜鼓吹 @[563,576) | sg1:「《江表传》记载：孙策又给周瑜配备鼓吹乐队……」 | observation：译文含「《江表传》记载：孙策又给周瑜配备鼓吹乐队」；原文锚点见左。[hypothesis] 嵌注归属 | |
| C10 馬超背景 | 馬超、韓遂尚在關西 @[8589,8598) | zz:「……马超、韩遂还在关西，是曹操的后患……」 | observation：zz 译文含「马超、韩遂还在关西，是曹操的后患」；当前 ZZ bundle 无 馬超 entity。[hypothesis] 是否仅为背景提及、无 direct claim | |
| C11 首部完整 | 三傳開篇＋通鑑卷首 @[0,..) | sg0/sg1/sg2 開篇；zz:「《资治通鉴》第六十五卷。汉纪五十七……」 | observation：各章首段如左列窗口（zz 首段无「卷第六十五/第065卷」字样，仅「第六十五卷」）。[hypothesis] 首部完整性 | |
