...
本工作包给出每案的原文锚点、当前 candidate 对应译文窗口、引用/事件/边界要点；
**判定、依据、证据三栏一律留空**，由独立 reviewer 填写，本任务不预置、不代填。
译文窗口取自 SG `01a08b08`（revision `d848e43a`）/ZZ `01a08ad9`。

| 案 | 原文锚点 @[start,end) | 当前译文窗口（节选） | 引用/事件/边界要点 | Reviewer 判定 / 依据 / 证据 |
| --- | --- | --- | --- | --- |
| C01 先主/備 | 先主姓劉，諱備 @[0,7)；先主少孤，與母販履織蓆為業 @[102,115) | sg0:「先主姓刘，名备，字玄德，是涿郡涿县人……」 | 同章共指；SG 先主傳 mention 先主→劉備 | |
| C02 周瑜/公瑾 | 周瑜字公瑾 @[0,5)；孤念公瑾，豈有已乎？ @[5006,5016) | sg1:「周瑜，字公瑾，是庐江舒县人……」 | 同章字号；alias 公瑾有据 | |
| C03 魯肅/子敬 | 魯肅字子敬 @[0,5)；子敬，孤持鞍下馬相迎，足以顯卿未？ @[2068,2085) | sg2:「……子敬，我扶着马鞍下马迎接，足以显扬您了吗？」 | 同章字号；alias 子敬 | |
| C04 赤壁跨章 | 與曹公戰於赤壁，大破之 @[5114,5125)；遇於赤壁 @[2320,2324) | sg0:「和曹公在赤壁交战，大败曹军，焚烧他的船只……」；sg1:「军队继续前进，在赤壁与曹操相遇……」 | **同 revision event candidate 缺失**；仅 `fdeec79e` 赤壁 place `same_entity`；不得用 `848a296f`/历史 SG3（§25.5） | |
| C05 赤壁跨書 | 遇於赤壁 @[2320,2324)；進，與操遇於赤壁 @[9270,9278) | sg1:「……在赤壁相遇……」；zz:「军队继续前进，在赤壁与曹操相遇。」 | 跨書 event（§22 cross_book×event 4/4 terminal） | |
| C06 周瑜督軍跨書 | 遂以周瑜、程普為左右督，將兵與備並力逆操 @[9067,9087)；權遂遣瑜及程普等與備並力逆曹公 @[2304,2319) | zz:「于是任命周瑜、程普为左右都督，率军与刘备合力迎击曹操……」；sg1:「……与刘备合力迎击曹操……」 | 跨書 entity 周瑜/程普（§22 cross_book×entity） | |
| C07 南郡/江陵 | 追操至南郡 @[9577,9582)；留征南將軍曹仁、橫野將軍徐晃守江陵 @[9598,9615) | zz:「……等他到达南郡时，刘琮已经投降……」 | 南郡≠江陵，须保留 uncertain/不合并 | |
| C08 典略注 | 〈《典略》曰：備本臨邑侯枝屬也。〉 @[58,75) | sg0:「〈《典略》说：刘备原是临邑侯的支属。〉」 | 嵌注歸屬，位置正确 | |
| C09 江表傳注 | 《江表傳》曰：策又給瑜鼓吹 @[563,576) | sg1:「《江表传》记载：孙策又给周瑜配备鼓吹乐队……」 | 嵌注歸屬，位置正确 | |
| C10 馬超背景 | 馬超、韓遂尚在關西 @[8589,8598) | zz:「……马超、韩遂还在关西，是曹操的后患……」 | 僅背景提及；ZZ bundle 無馬超 direct claim | |
| C11 首部完整 | 三傳開篇＋通鑑卷首 @[0,..) | sg0/sg1/sg2 開篇；zz:「《资治通鉴》第六十五卷。汉纪五十七……」 | 首部完整；ZZ 卷题行观察 | |
| C12 尾部完整 | 先主傳讖語尾 @[12552,12571)；通鑑卷末 @[10673,10679) | sg0 尾:「……先主将死。〉」；zz 尾:「……孙权于是分割当地设置新都郡，任命贺齐为太守。」 | 尾部完整 | |
| C13 習鑿齒論曰 | 習鑿齒論曰：昔齊桓一矜其功而叛者九國 @[10078,10096) | zz:「习凿齿评论说：刘玄德虽然颠沛流离……」 | 史論歸屬，非同期言论；bundle 無習鑿齒 entity | |
