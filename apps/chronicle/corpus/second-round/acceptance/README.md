...
- [`reading-review-20260912.md`](reading-review-20260912.md)：最新独立复核，
  含三处具体删略的原文／初稿／修正稿对照。

## 最近重跑结论（2026-09-12）

**未通过。** v4 的《先主傳》在初稿和一次纠错后仍不合法；修正稿合并了段落、
删除事件 span，并遗漏具体内容。本次没有 accepted 章、审核项或发布，不用
首次运行的四章发布结果代替。#586、#549 保持未验收。
