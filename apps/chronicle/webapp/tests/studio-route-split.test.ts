...
describe("Chronicle Studio operations remain route-split", () => {
  it("lazy-loads imports, review queue/detail, sources, coverage, and backgrounds outside public navigation", () => {
    ...
    expect(app).toContain('lazy(() => import("./pages/studio/StudioBackgroundsPage"))');
    ...
    expect(app).toContain('path="backgrounds"');
