...
//     --suite harness|content|axis|position|events|context|all \
...
import { defaultOutputDir, FIXTURE_PATH, runReadingSuites, SUITE_NAMES } from "../tests/reading-browser/harness.mjs";
...
const validSuites = [...SUITE_NAMES, "all"];
if (!baseUrl) {
